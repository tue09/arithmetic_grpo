...
Then rerun, for example:
  DATA_SETTING=history_to_aime24 bash $PROJECT_DIR/run_qwen2-5_3b_grpo_aime_history_4gpu.sh
  DATA_SETTING=history_to_aime25 bash $PROJECT_DIR/run_qwen2-5_3b_grpo_aime_history_4gpu.sh
EOF
    exit 1
fi
