...
class AlgoConfig(BaseConfig):
    ...
    Args:
        ...
        adv_estimator (str): Advantage estimator type: "gae", "grpo", "QAE", "reinforce_plus_plus", etc.
        norm_adv_by_std_in_grpo (bool): Whether to normalize advantages by std (specific to GRPO).
        qae_quantile (float): Right-continuous empirical quantile used by QAE as the group baseline.
        qae_norm_by_std (bool): Whether to divide QAE advantages by the within-group std.
    ...
    qae_quantile: float = 0.4
    qae_norm_by_std: bool = True
