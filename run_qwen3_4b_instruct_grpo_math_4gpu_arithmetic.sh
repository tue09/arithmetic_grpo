#!/usr/bin/env bash
# Paper-aligned MATH arithmetic-GRPO baseline for Qwen3-4B-Instruct.
...
RUN_TAG="${RUN_TAG:-qwen3_4b_instruct_grpo_math_paper_4gpu_arithmetic_clip_ratio_high_0.24_QAE_adv}"
...
"$PYTHON_BIN" -m verl.trainer.main_ppo \
    algorithm.adv_estimator=QAE \
    algorithm.qae_quantile=0.4 \
    algorithm.qae_norm_by_std=True \
