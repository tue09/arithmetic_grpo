#!/usr/bin/env bash
# Paper-aligned MATH GRPO baseline for Qwen2.5-Math-1.5B.
...
RUN_TAG="${RUN_TAG:-qwen2_5_math_1_5b_grpo_math_paper_4gpu}"
...
Then rerun:
  bash $PROJECT_DIR/run_qwen2-5_math_1-5b_grpo_math_4gpu.sh
EOF
    exit 1
fi
