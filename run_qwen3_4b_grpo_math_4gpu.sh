...
MODEL_PATH="${MODEL_PATH:-/mnt/data/safetyCode/model_hub/Qwen/Qwen3-4B}"
...
CHECKPOINT_DIR="${CHECKPOINT_DIR:-$PROJECT_DIR/checkpoints/qwen3_4b_grpo_math_4gpu}"
...
Then rerun:
  bash $PROJECT_DIR/run_qwen3_4b_grpo_math_4gpu.sh
EOF
    exit 1
fi
